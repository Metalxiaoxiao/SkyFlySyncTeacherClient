        ...
        dispatch(
          onSendingMessage({
            ...
            content: {
              ...
              type: route.params.messageType.messageType,
              data: {
                id: Date.now(),
                title: title,
                sender: userName,
    ...
    <Provider theme={theme}>
      <View style={styles.container}>
        ...
        <View style={styles.checkboxContainer}>
          <Checkbox
            status={ifDialogChecked ? 'checked' : 'unchecked'}
            onPress={() => setIfDialogChecked(!ifDialogChecked)}
